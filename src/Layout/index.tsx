...
// Создаем компоненты-обертки с правильной типизацией
const TypedHeader = (props: any) => <Header {...props} />;
const TypedTopBar = (props: any) => <TopBar {...props} />;
const TypedHorizontalLayout = (props: any) => <HorizontalLayout {...props} />;
const TypedVerticalTab = (props: any) => <VerticalTab {...props} />;
const TypedModuler = (props: any) => <Moduler {...props} />;
  ...
  return (
    <>
      {layoutTheme === "vertical" ?
        <>
          <TypedHeader themeMode={themeMode} />
          <TypedTopBar
