...
const EddsPlannedWorksPage: React.FC = () => {
  ...
  const loadData = async (page = 1) => {
    ...
    try {
      ...
      const response = await getEddsPlannedWorks(params);
      setData(response);
      setCurrentPage(page);
      setLoading(false);
    } catch (error) {
          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              <div className="page-header-title">
                <h5 className="m-b-10">Плановые работы</h5>
              </div>
              <ul className="breadcrumb">
                ...
                <li className="breadcrumb-item">Плановые работы</li>
              </ul>
            </div>
          ...
          <Card>
            <Card.Header className="d-flex justify-content-between align-items-center py-2">
              <Card.Title as="h5" className="mb-0">
                <i className="ti ti-calendar me-2 text-warning"></i>
                Плановые работы
                {!loading && data && (
                  <Badge 
                    bg="primary" 
            ...
            <Card.Body>
              ...
              {view === 'table' ? (
                <EddsTable
                  ...
                  storageKey="eddsPlannedWorksColumns"
...
export default EddsPlannedWorksPage;