  ...
  const fetchMapData = async (filterParams?: FilterState): Promise<void> => {
    try {
      ...
      if (filterParams?.resource_type_id) {
        params.append('resource_type_id', filterParams.resource_type_id.toString());
      }
      if (filterParams?.equipment_type_id) {
        params.append('equipment_type_id', filterParams.equipment_type_id.toString());
      }
      if (filterParams?.org_id) {
        params.append('org_id', filterParams.org_id.toString());
      }
