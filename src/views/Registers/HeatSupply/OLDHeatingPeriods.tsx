...
const HeatingPeriods: React.FC = () => {
    ...
    const [columns, setColumns] = useState<TableColumn[]>([
        ...
        { id: 'houseNumber', title: 'ДОМ', width: 100, visible: true, field: 'address.house_number' },
        { id: 'entranceCount', title: 'ПОДЪЕЗДЫ', width: 100, visible: true, field: 'entrance_count' },
        { id: 'buildingYear', title: 'ГОД ПОСТРОЙКИ', width: 120, visible: true, field: 'buildingYear' },
        { id: 'cadastreNumber', title: 'КАДАСТР НОМЕР', width: 180, visible: true, field: 'cadastreNumber' },
        { id: 'planSeries', title: 'ПЛАН', width: 150, visible: true, field: 'planSeries' },
        { id: 'houseCondition', title: 'СОСТОЯНИЕ', width: 150, visible: true, field: 'house_condition.houseCondition' },
        { id: 'houseType', title: 'ТИП', width: 150, visible: true, field: 'house_type.houseTypeName' },
        { id: 'managementOrg', title: 'УПРАВЛЯЮЩАЯ ОРГ', width: 250, visible: true, field: 'management_org.shortName' },
        { id: 'municipalityOrg', title: 'МУНИЦИПАЛЬНАЯ ОРГ', width: 250, visible: true, field: 'municipality_org.shortName' }
    ]);
