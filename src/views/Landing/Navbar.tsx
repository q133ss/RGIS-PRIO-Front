    ...
    return (
        <React.Fragment>
            <nav id="top-nav" className="navbar navbar-expand-md navbar-light default">
                <Container>
                    <Link to="/dashboard" className="pc-navbar-brand">
                        {themeMode === "dark" ?
                            <img src={logoLight} alt="logo" className="logo-lg" />
                            :
                            <img src={logoDark} alt="logo" className="logo-lg" />
                        }
                    </Link>
                    <Navbar.Toggle aria-controls="navbarTogglerDemo01" onClick={handleMenu} />
                    <Navbar.Collapse id="navbarTogglerDemo01" className={`${display === true ? 'show' : ""}`}>
                        ...
                        <Nav as="ul" className="mb-2 mb-lg-0 align-items-start">
                            ...
                            <Button variant="primary" href="https://phoenixcoded.com/item/light-able-bootstrap-admin-dashboard/" target="_blank" className="buynowlinks">
